# 💫 Sobre mim:
### Olá! 👋<br><br>Sou Heitor Stefani Alves, estudante de Engenharia de Computação com paixão por desenvolvimento de software. Tenho experiência em JavaScript para Node.js e React. Estou sempre buscando expandir meu conhecimento e atualmente estou explorando outras linguagens e tecnologias.<br><br>🔭 **Atualmente estudando:** Integração de sistemas e desenvolvimento web full stack.<br>🌱 **Aprendendo sobre:** Novas linguagens de programação e ferramentas para desenvolvimento de software.<br>👯 **Aberto para colaborações em:** Projetos de código aberto e iniciativas de desenvolvimento de software que tenham impacto positivo.<br>💬 **Pergunte-me sobre:** Node.js, React, ou qualquer coisa relacionada a engenharia de software.<br>⚡ **Curiosidade:** Além de codificar, sou fascinado por tecnologia emergente e seu impacto na sociedade.
